...
| Scoped epoch accepted without a live scene transition test | M | H | Keep retail actor traversal disabled until normal scene exit invalidates the token and re-entry establishes a new epoch | observer/runtime bridge |
