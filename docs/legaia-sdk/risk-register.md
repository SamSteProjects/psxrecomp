...
| Internally stable requests combined across changing executable state | H | H | Two-sample epochs and before/after validation reject the entire attempt; retail observer remains unaccepted until a generic bounded multi-request boundary exists | observer/runtime bridge |
