...
- completed generic observer foundations through protocol 1.3: safe runtime/executable identities, authoritative watched-generation reporting, native validity, backend-neutral execution-owner observations, bounded frame-stamped `read_regions`, an eight-record executable catalog, and bounded image-lifecycle pages. These changes are generic and contain no Legaia addresses or traversal logic.
